...
public class GroupByKeyExample {
    ...
    public static void main(String[] args) {
        ...
        // Step 1
        PCollection<String> pCustOrderList = p.apply(TextIO.read().from("C:\\Users\\shlomi_e\\apache-beam-course-materials\\project\\data\\section4\\GroupByKey_data.csv"));
        ...
        output.apply(TextIO.write().to("C:\\Users\\shlomi_e\\apache-beam-course-materials\\project\\data\\section4\\group_by_output.csv").withHeader("Id,Amount").withNumShards(1).withSuffix(".csv"));
