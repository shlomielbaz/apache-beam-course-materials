...
public class StarterPipeline {
    ...
    public static void main(String[] args) {
        ...
        options.setTempLocation("gs://udemy_training_beam/input");
        options.setStagingLocation("gs://udemy_training_beam/input");
        options.setProject("beam-276305");
        ...
        PCollection<String> pInput =p.apply(TextIO.read().from("gs://udemy_training_beam/input/user.csv"));
        ...
        pInput.apply(ParDo.of(new DoFn<String, TableRow>() {
                ...
                .apply(BigQueryIO.writeTableRows().to("udemy_training.user_tbl")
