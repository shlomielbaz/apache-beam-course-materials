...
//		Step 1 : Read csv file.
        ...
        PCollection<String> fileInput= pipeline.apply(TextIO.read().from("data/section9/user_order.csv"));
...
//		Step 4 : Convert PCollection<Row> to PCollection<String>
        ...
        pOutput.apply(TextIO.write().to("data/section9/sql_count_output.csv").withNumShards(1).withSuffix(".csv"));
